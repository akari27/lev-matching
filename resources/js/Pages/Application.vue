                                        ...
                                        <div>
                                            <div class="text-base mx-2 w-full">
                                                <div class="mt-4 flex">
                                                    ...
                                                    <p class="w-4/5 ml-2">{{ send.add_info.foreign_visitor.start_of_stay }} ~ {{ send.add_info.foreign_visitor.end_of_stay }}</p>
                                                </div>
                                                <div class="mt-2 flex">
                                                    <p class="w-1/5 font-bold text-[#6c8489]">訪問場所</p>
                                                    <p class="w-4/5 ml-2">{{ send.stay_location }}</p>
                                                </div>
                                                <div class="mt-2 flex">
                                                ...
                                                <div class="mt-2 flex">
                                                    ...
                                                    <p class="w-4/5 ml-2">{{ send.add_info.foreign_visitor.reason }}</p>
                                                </div>
                                                <div class="mt-2 flex">
                                        ...
                                        <div>
                                            <div class="text-base mx-2 w-full">
                                                <div class="mt-4 flex">
                                                    <p class="w-1/5 font-bold text-[#6c8489]">滞在期間</p>
                                                    <p class="w
                                                    -4/5 ml-2">{{ recieve.add_info.foreign_visitor.start_of_stay }} ~ {{ recieve.add_info.foreign_visitor.end_of_stay }}</p>
                                                </div>
                                                <div class="mt-2 flex">
                                                    <p class="w-1/5 font-bold text-[#6c8489]">訪問場所</p>
                                                    <p class="w-4/5 ml-2">{{ recieve.stay_location }}</p>
                                                </div>
                                                <div class="mt-2 flex">
                                                    <p class="w-1/5 font-bold text-[#6c8489]">趣味</p>
                                                ...
                                                <div class="mt-2 flex">
                                                    <p class="w-1/5 font-bold text-[#6c8489]">訪日理由</p>
                                                    <p class="w-4/5 ml-2">{{ recieve.add_info.foreign_visitor.reason }}</p>
                                                </div>
                                                <div class="mt-2 flex">
                                                    <p class="w-1/5 font-bold text-[#6c8489]">ヒトコト</p>
                                    ...
                                    <div class="text-[#004758] text-base/7 flex flex-col w-full">
                                        ...
                                        <div>
                                            <div class="text-base mx-2 w-full">
                                                <div class="mt-4 flex">
                                                    <p class="w-1/5 font-bold text-[#6c8489]">滞在期間</p>
                                                    <p class="w-4/5 ml-2">{{ approved.add_info.foreign_visitor.start_of_stay }} ~ {{ approved.add_info.foreign_visitor.end_of_stay }}</p>
                                                </div>
                                                <div class="mt-2 flex">
                                                    <p class="w-1/5 font-bold text-[#6c8489]">訪問場所</p>
                                                    <p class="w-4/5 ml-2">{{ approved.stay_location }}</p>
                                                </div>
                                                <div class="mt-2 flex">
                                                    <p class="w-1/5 font-bold text-[#6c8489]">趣味</p>
                                                ...
                                                <div class="mt-2 flex">
                                                    <p class="w-1/5 font-bold text-[#6c8489]">訪日理由</p>
                                                    <p class="w-4/5 ml-2">{{ approved.add_info.foreign_visitor.reason }}</p>
                                                </div>
                                                <div class="mt-2 flex">
                                                    <p class="w-1/5 font-bold text-[#6c8489]">ヒトコト</p>
