                                    ...
                                    <div>
                                        <div class="text-base mx-2 w-full">
                                            <div class="mt-4 flex">
                                                ...
                                                <p class="w-4/5 ml-2">{{ props.user_data.register_location }}</p>
                                            </div>
                                            <div class="mt-2 flex">
                                                <p class="w-1/5 font-bold text-[#6c8489]">よく行く</p>
                                                <p class="w-4/5 ml-2">{{ props.user_data.often_go_location }}</p>
                                            </div>
                                            <div class="mt-2 flex">
                                                <p class="w-1/5 font-bold text-[#6c8489]">趣味</p>
                                                <p class="w-4/5 ml-2">{{ props.user_data.hobby_category }}</p>
                                            </div>
                                            <div class="mt-2 flex">
